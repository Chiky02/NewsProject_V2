...
const selectedFile2 = imageInput.files[0];
const imagePreview = document.getElementById('imagenNoticia'); // Assuming 'imagePreview' is the ID of your image preview element
formularioNoticia.addEventListener('submit', (event) => crearNoticia(event, selectedFile2));
...
async function crearNoticia(event, selectedFile) {
