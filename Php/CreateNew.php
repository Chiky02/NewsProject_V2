...
if (!empty($data['date']) && !empty($data['body']) && !empty($data['stateNew']) && !empty($data['title']) && isset($data['user']) && isset($data['categoryId'])) {
    // && !empty($data['photoLink'])
    ...
    $stmt->bind_param('ssssdds', $data['date'], $data['body'], $data['stateNew'], $data['title'], $data['user'], $data['categoryId'], $data['photoLink']);
